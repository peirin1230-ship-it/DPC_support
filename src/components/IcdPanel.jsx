...
export default function IcdPanel({results,onClose,isMobile}){
  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.3)",zIndex:1000,display:"flex",alignItems:"center",justifyContent:"center",padding:isMobile?0:20}} onClick={onClose}>
      <div ref={modalRef} role="dialog" aria-modal="true" aria-label="対象ICD-10一覧" style={{background:"#FFFFFF",borderRadius:isMobile?0:12,border:isMobile?"none":"1px solid #E0E0E0",boxShadow:isMobile?"none":"0 16px 48px rgba(0,0,0,.12)",maxWidth:isMobile?"100vw":"90vw",width:isMobile?"100%":600,maxHeight:isMobile?"100dvh":"85vh",height:isMobile?"100dvh":"auto",display:"flex",flexDirection:"column",padding:isMobile?12:20}} onClick={e=>e.stopPropagation()}>
